...
export type { PluginOptions, SvgProps, SvgColor, SvgBase64, NumberWithUnit } from './types'
...
function generateSvgTypes(svgDir: string, outputPath: string, root: string) {
  ...
  const moduleContent = `// Auto-generated by vite-plugin-svelte-svg
// Do not edit manually

import { Svg as BaseSvg, initSvg } from 'vite-plugin-svelte-svg/runtime'
...
`
  ...
  console.log(`[vite-plugin-svelte-svg] Generated: ${outputPath.replace('.d.ts', '.ts')}`)
}
