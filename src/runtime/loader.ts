import type { SvgModule, SvgRegistry } from '../types'
import { setSvgRegistry } from './Svg.svelte'

/**
 * Initialize SVG registry from glob import result
 * @example
 * import { initSvg } from 'vite-plugin-svelte-svg/runtime'
 * initSvg(import.meta.glob('./your-svg-dir/*.svg'))
 */
export function initSvg(globResult: Record<string, SvgModule>): SvgRegistry {
